...
{   
  ...
  if((hours == hours1 && minutes == minutes1 && seconds == seconds1) || (hours == hours2 && minutes == minutes2 && seconds == seconds2) || (hours == hours3 && minutes == minutes3 && seconds == seconds3) || (hours == hours4 && minutes == minutes4 && seconds == seconds4) || (hours == hours5 && minutes == minutes5 && seconds == seconds5))
  {
...
int askingbouttime(bool stateh, int reszta, int changevalue, int whosetimeisit, String question1, String question2)
{
  delay(300);
